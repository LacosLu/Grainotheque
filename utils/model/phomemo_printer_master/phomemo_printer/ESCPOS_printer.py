        ...
        for start_index in range(0, image.height, 256):
            ...
            for image_line_index in range(line_height):
                ...
                for byte_start in range(int(image.width / 8)):
                    ...
                    if byte == 0x0A:
                        byte = 0x14
                    # self._print_bytes(byte.to_bytes(1, 'little')) / Ligne retirer car reduit le temps d'impretion et bloque la machine. 
...
# def add_margins(image, target_width):
#         """
#         Ajoute des marges blanches pour centrer l'image si elle est plus petite que target_width
#         """
#         img_width, img_height = image.size
#         if img_width >= target_width:
#             return image  # Pas besoin de marge

#     # Calcul de la marge
#         left_margin = (target_width - img_width) // 2
#         new_img = Image.new("1", (target_width, img_height), "white")
#         new_img.paste(image, (left_margin, 0))
#         return new_img
