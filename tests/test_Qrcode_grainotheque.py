...
class test_Qrcode_grainotheque(TestCase):
    ...
    def setUp(self):
        self.__chemin_image = './utils/temps'
    ...
    def test_lecture_qrcode_lisible(self):
        ...
        fichier_image = f"{self.__config_qrcode['chemin_image']}/{nom_image_lu}"
        self.assertTrue(os.path.exists(fichier_image))
    ...
    def test_lecture_qrcode_non_lisible(self):
        ...
        try:
            self.assertRaises(Exception, self.__qr.lecture_qrcode(nom_image_lu))
